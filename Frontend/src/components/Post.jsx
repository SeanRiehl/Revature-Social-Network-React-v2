        ...
        <div className="col-4" id="post-div">
            <div className="card" id="post">
                ...
                <div className="container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={`${like ? `blue` : ``} bi bi-arrow-up-square-fill`} viewBox="0 0 16 16" onClick={
                        function () {
                            setLike(!like)
                            if (like) {
                                setCount(count - 1)
